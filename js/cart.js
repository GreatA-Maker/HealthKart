...
function displayItem(showCartaItem) {
  ...
  showCartaItem.forEach(function (item) {
...
var total = showCartaItem.reduce(function (startingValue, currentValue) {
  return startingValue + Number(currentValue.oriPrice);
}, 0);
...
document.querySelector("#payButton").innerHTML =
  "Proceed to Pay: " + `  ₹${finalPay}`;

// =================  total Dis  ============

var discount = total - finalPay;
